...
* [All the Names of Waiting](https://archiveofourown.org/works/70894036). This story states explicitly in its summary that Hermione and Viktor are first torn apart by the war, and only find each other back after 12 years. The author of this story explicitly stated that many people hate this choice in the plot. Obviously, such a choice has nothing to do with the quality of a story; what matters is whether it is done right (the rubric is designed around this principle). But people's choices to read a story do depend heavily on such choices. As uch, it is reasonable to assume that the Hits and Popularity of this story do not do it justice (that is why it is recommended as a hidden gem). Hence, also here, the normal relation between Popularity and Rubric score is clearly distorted, so we eliminate it from the correlation study.

Choice to eliminate a story from the correlation study are solely based on whether an explicite statement of the author was available as evidence/indication that the relationship between Popularity and Rubric score could be distorted. Alls stories where such statements were unavailable have just been taken along in the study. The resulting figure (for the remaining 28 stories) is shown above.

The Pearson correlation between Popularity (lifecycle*Hits/Time) and Total rubric score was found to be ρ=0.44

This is a good confirmation of our hypothesis. We already know that the rubric measures different aspects of the same underlying principle (α = 0.78±0.01), which we hope to be intrinsic story quality. It stands to reason to assume that readers can recognise (to some degree) the intrinsic quality of a story, meaning that Popularity and Rubric score are expected to be positively correlated. However, Popularity is also expected to heavily depend on other aspects, such as peoples preference for certain plot choices and characterizations, and marketing/advertisement on social media. As such, a correlation that is significantly higher then zero, but far from close to one, is exactly what one would expect. And what was found with ρ=0.44

Furthermore, the figure also clearly shows a significant slope in the trentline (calculated with least squares method). The actual value has little meaning, as Popularity and Rubric score have different units. But depending on a good or bad rubric score, the trendline shows that popularity almost quadruples. This, together with ρ=0.44, forms a clear indication that the Rubric score indeed measures intrinsic quality.
...
Obviously, the fact that the rubric was aimed to measure intrinisc story quality, and that the scores are correlated to Popularity with ρ=0.44 and a significant slope, is not a full proof that the rubric indeed measures intrinisc story quality in an unbiased and reproducible way. But it is a clear indication. Which is the best result one can hope to achieve, as the notion of quality is different for each human being and, therefore, hardly objecvtive.

# Conclusion

The rubric clearly measures differnet aspects of the same underlying property (α = 0.78±0.01) in a meaningful (MRD = 5.7, σ=13.3) and reproducible (Spearman ρ=0.92) way. The fact that the total rubric score correlated to a story's popularity with ρ=0.44 and a significant slope, together with how the rubric is designed (non-discriminatively), forms a clear indicatuion that this underlying dminesion is the intrinisc or execution quality of a story. But not a full proof.
